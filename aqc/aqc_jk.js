/*
爱企查-监控商品
爱企查下载地址：https://aiqicha.baidu.com/m/usercenter/inviteCode?uid=xlTM-TogKuTwsCqEW-1e8u5miLJmky3SjAmd
            ...
            try {
                if (err) {
                    ...
                    if(data.data.AQ03008){
                        let name = "京东E卡50元"
                        let msg = "贝母为你监控的【" + name + "】有库存了，快点来兑换 https://qiye.baidu.com/usercenter#/mall"
